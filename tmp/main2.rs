        ...
        html! {
            ...
            <div>
                <div class="panel">
                    ...
                    <button class="button" onclick={ctx.link().callback(|_| Msg::GetMembers)}>
                        { "+1" }
                    </button>
      ...
      <div class="navbar-content">
        ...
        <div class="navbar-links">
          <ul class="navbar-link">
            ...
            <li class = "navbar-item"><button class="button" onclick={ctx.link().callback(|_| Msg::GetMembers)}>{"Liste des membres"}</button></li>
        ...
        <div class="FAQ-content">
          ...
          <p>{"Les nems sont princialement fait de porc mais la chef peut en faire d'autre si il y eu
            demande au préalable."}</p>
             ...
             //<VideosList videos={(*self.videos).clone()} />
            //{videos}
